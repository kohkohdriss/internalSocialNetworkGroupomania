        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8" id="allMessages">
                    <a  href="" data-toggle="modal" data-target="#modalAddMessage" class="my-2 btn btn-lg btn-block btn-success">Poster un message...</a>
                                    ...
                                    <div class="row modal-body">
                                        ...
                                        <div class="col-12 justify-content-center">
                                            <div class="form-group justify-content-center">
                                                ...
                                                <input @change="readFile()" type="file" ref="file" name="image" class="form-control-file" id="File" accept=".jpg, .jpeg, .gif, .png">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div v-for="message in messages" :key="message.id" class="card bg-light my-3">
                        <div class="card-header bg-light d-flex align-items-center justify-content-between m-0 p-1">
                            ...
                            <div v-if="message.UserId == this.currentUserId || this.isAdmin == 'true'">
                                <!-- modifier le message ou le supprimer -->
                                <a :href="'#/message/edit/' + message.id"><img src="/images/edit.svg" class="m-1 p-0" alt="Modifier le message" title="Modifier le message"/></a>
